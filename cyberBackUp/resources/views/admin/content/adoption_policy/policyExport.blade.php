...
<body>
    ...
    <div id="coverPage" class="cover-page print-page">
        <!-- Logo top left -->
        <div class="logo-container print-logo-left">
            <img src="{{ asset('images/ksu-logo.png') }}" alt="KSU Logo" class="ksu-logo">
        </div>

        <!-- Blue left sidebar (optional for print, can be removed) -->
        <div class="left-sidebar print-sidebar"></div>

        <!-- Main content -->
        <div class="cover-main-content print-cover-content text-center">
    ...
    <!-- Main NDA Content Page for Print -->
    <div id="ndaPage" class="nda-container print-page">
        <div class="container-fluid">
            <div class="card-body">
                <!-- Centered Logo -->
                <div class="logo-container text-center mb-4">
                    <img src="{{ asset('images/ksu-logo.png') }}" alt="KSU Logo" class="ksu-logo print-logo-center">
                </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($reviewers as $reviewer)
                                @php
                                    $statusJson = $policy->reviewer_status
                                        ...
                                        : [];
                                    $status = $statusJson[$reviewer->id]['status'] ?? 'pending';
                                @endphp
                                <tr>
                                    <td>{{ $reviewer->name }}</td>
                            ...
                            @foreach ($owners as $owner)
                                @php
                                    ...
                                    $status = $statusJson[$owner->id]['status'] ?? 'pending';
                                @endphp
                                <tr>
                                    <td>{{ $owner->name }}</td>
                            ...
                            @foreach ($authorizeds as $auth)
                                @php
                                    $statusJson = $policy->authorized_person_status
                                        ...
                                        : [];
                                    $status = $statusJson[$auth->id]['status'] ?? 'pending';
                                @endphp
                                <tr>
                                    <td>{{ $auth->name }}</td>
                                    <td>{{ $auth?->job?->name }}</td>
