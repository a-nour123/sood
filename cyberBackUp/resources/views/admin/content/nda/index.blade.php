        ...
        <div class="dashboard container-fluid py-4">
            ...
            <div class="row mb-4">
                <div class="col-12 text-center">
                    <h2 class="fw-bold mb-1">📈 {{ __('locale.NDAStatistics') }}</h2>
                    <p class="text-muted">{{ __('locale.OverviewOfAgreementsAndProgress') }}</p>
            ...
            <div class="stats-container row g-4">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="stat-card shadow-lg border-0 rounded-4 p-4 text-center h-100">
                        ...
                        <h6 class="stat-title text-uppercase fw-bold text-secondary">{{ __('locale.TotalNDAs') }}</h6>
                        <h3 class="stat-value fw-bold text-dark mb-1" id="totalNDAs">{{ $statistics['total'] }}</h3>
                        <p class="stat-description text-muted small mb-0">{{ __('locale.AllTimeAgreements') }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="stat-card shadow-lg border-0 rounded-4 p-4 text-center h-100">
                        <div class="stat-icon display-4 mb-2">🆕</div>
                        <h6 class="stat-title text-uppercase fw-bold text-secondary">{{ __('locale.CreatedToday') }}
                        </h6>
                        <h3 class="stat-value fw-bold text-primary pulse-animation mb-1" id="todayNDAs">
                            {{ $statistics['today'] }}
                        </h3>
                        <p class="stat-description text-muted small mb-0">{{ __('locale.NewAgreementsToday') }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="stat-card shadow-lg border-0 rounded-4 p-4 text-center h-100">
                        <div class="stat-icon display-4 mb-2">📅</div>
                        <h6 class="stat-title text-uppercase fw-bold text-secondary">{{ __('locale.ThisMonth') }}</h6>
                        <h3 class="stat-value fw-bold text-success mb-1" id="monthNDAs">{{ $statistics['this_month'] }}
                        </h3>
                        <p class="stat-description text-muted small mb-0">{{ __('locale.MonthlyProgress') }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="stat-card shadow-lg border-0 rounded-4 p-4 text-center h-100">
                        <div class="stat-icon display-4 mb-2">🕒</div>
                        <h6 class="stat-title text-uppercase fw-bold text-secondary">{{ __('locale.LastUpdated') }}
                        </h6>
                        <h5 class="stat-value fw-bold text-dark mb-1" id="lastUpdated">
                            {{ $statistics['last_updated'] ?? 'N/A' }}
                        </h5>
                        <p class="stat-description text-muted small mb-0">{{ __('locale.RealTimeSync') }}</p>
                    </div>
                </div>
            </div>
        </div>
