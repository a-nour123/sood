            ...
            <div class="card-body">
                ...
                <div class="action-section">
                    <div class="action-body">
                        <div class="action-description" @if ($userTakeAction) hidden @endif>
                            <i class="fas fa-info-circle me-2 text-primary"></i>
                            {{ __('locale.Please review the NDA content above carefully and choose your action. This decision will be recorded and cannot be changed.') }}
                        </div>
                            ...
                            <div class="card border-0 shadow-sm p-3 mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    {{-- <div class="text-muted">
                                            @if ($userTakeAction->comments)
                                                <small>
                                                    <i class="fas fa-comment-alt me-1"></i>
                                                    {{ $userTakeAction->comments }}
                                                </small>
                                            @else
                                                <small>{{ __('locale.No comments provided') }}</small>
                                            @endif
                                        </div> --}}
                                </div>
                            </div>
