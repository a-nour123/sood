...
<script>
    var table = $('.dt-advanced-server-search').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '{{ route('admin.phishing.senderProfile.PhishingSenderProfileDatatable') }}'
        },
        language: {
...
<script>
    ...
    $(document).on('change', "input[type=radio][name=type]", function() {
        ...
        if($(this).val() == 'own'){
            ...
            $("#edit-regulator form").find('#website_domain_id_div').hide().trigger('change');
            $("#edit-regulator form").find('#website_from_address_name_div').removeClass('col-6').addClass('col-12').trigger('change');
            $("#edit-regulator form").find('#website_domain_id').prop('required', false).trigger('change');

            $("#add-new-senderProfile form").find('#website_domain_id_div').hide().trigger('change');
            $("#add-new-senderProfile form").find('#website_from_address_name_div').removeClass('col-6').addClass('col-12').trigger('change');
            $("#add-new-senderProfile form").find('#website_domain_id').prop('required', false).trigger('change');
        } else {
            $("#edit-regulator form").find('#website_domain_id_div').show().trigger('change');
            $("#edit-regulator form").find('#website_from_address_name_div').removeClass('col-12').addClass('col-6').trigger('change');
            $("#edit-regulator form").find('#website_domain_id').prop('required', true).trigger('change');

            $("#add-new-senderProfile form").find('#website_domain_id_div').show().trigger('change');
            $("#add-new-senderProfile form").find('#website_from_address_name_div').removeClass('col-12').addClass('col-6').trigger('change');
            $("#add-new-senderProfile form").find('#website_domain_id').prop('required', true).trigger('change');
        }
    });
