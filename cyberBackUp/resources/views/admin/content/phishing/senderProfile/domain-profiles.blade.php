                    ...
                    <table class="dt-advanced-server-search table">
                        <thead>
                            <tr>
                                ...
                                <th class="all">{{ __('phishing.from_display_name') }}</th>
                                <th class="all">{{ __('phishing.from_address_name') }}</th>
...
<script>
    var table = $('.dt-advanced-server-search').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '{{ route('admin.phishing.domain.getProfilesDataTable',$domain->id) }}'
        },
        language: {
