    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="myExtraLargeModal">{{ __('locale.Add') }} {{ __('governance.Framework') }}</h4>
    ...
    <div class="modal-dialog sidebar-lg"> -->
        <div class="modal-content p-0">
            <form id="add_frame" class="add_frame todo-modal needs-validation" novalidate method="POST"
                  action="{{ route('admin.governance.framework.store_regulator') }}">
                @csrf

                <input type="hidden" name="regulator_id" class="regulator_id">
