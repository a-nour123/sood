<form action="" id="createProfileForm">
            ...
            <div id="generalInfoSection" class="accordion-collapse collapse show">
                <div class="accordion-body">
                    ...
                    <div class="row mb-2 contact-fields">
                        <div class="col">
                            <label for="ThirdPartyName" class="form-label">{{ __("third_party.Third party name") }}</label>
                    ...
                    <div class="row mb-2 contact-fields">
                        <div class="col">
                            <label for="Classification" class="form-label">{{ __("third_party.Classification") }}</label>
                        ...
                        <div class="col">
                            <label for="DateOfIncorporation" class="form-label">
                                {{ __("third_party.Date of incorporation") }}</label>
                    ...
                    <div class="row mb-2 contact-fields">
                        <div class="col">
                            <label for="PlaceOfIncorporation" class="form-label">{{ __("third_party.Place of incorporation") }}</label>
                            <textarea class="form-control" id="PlaceOfIncorporation" name="place_of_incorporation" rows="3"></textarea>
                        </div>
                        <div class="col">
                            <label for="HeadOfficeLocation" class="form-label">{{ __("third_party.Head office location") }}</label>
                            <textarea class="form-control" id="HeadOfficeLocation" name="head_office_location" rows="3"></textarea>
                        </div>
                    </div>
                    <hr>
                ...
                <div class="accordion-body">
                    ...
                    <div id="contactSection">
                        ...
                        <div class="row mb-3 contact-fields">
                            <div class="col">
                                <input type="text" class="form-control" name="contact_name[]" placeholder="{{ __("third_party.Name") }}">
                            </div>
                            <div class="col">
                        ...
                        <div class="row mb-3 contact-fields">
                            <div class="col">
                                <input type="text" class="form-control" name="entities_entity[]"
                                    placeholder="{{ __("third_party.Entity") }}">
                            </div>
                            <div class="col">
                                <input type="date" class="form-control" name="entities_date[]"
                                    placeholder="{{ __("third_party.Date") }}">
                            </div>
                            <div class="col">
    ...
    <div class="container">
        <button class="btn btn-success" type="submit" id="submitCreateForm">{{ __("third_party.Submit") }}</button>
    </div>
</form>
...
<script>
    ...
    $("#submitCreateForm").click(function(e) {
        ...
        var formData = $("#createProfileForm").serializeArray(); // Gather form data
        ...
        $.ajax({
            type: "POST",
            url: "{{ route('admin.third_party.saveProfile') }}",
            data: {
            ...
            beforeSend: function() {
                ...
                $.blockUI({
                    message: '<div class="d-flex justify-content-center align-items-center"><p class="me-50 mb-0">{{ __('locale.PleaseWaitAction', ['action' => 'Initiate Profile']) }}</p> <div class="spinner-grow spinner-grow-sm text-white" role="status"></div> </div>',
                    css: {
            ...
            success: function(response) {
                ...
                $("#submitCreateForm").attr("disabled", "disabled");
            ...
            error: function(xhr, status, error) {
                ...
                $("#submitCreateForm").removeAttr("disabled");
