...
<script>
    ...
    const nextLabel = "{{ __('locale.Next') }}";
    const finishLabel = "{{ __('locale.Finish') }}";
    const previousLabel = "{{ __('locale.Previous') }}";
                                    ...
                                    <ul class="nav nav-tabs mb-4" id="myActionTab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" id="action-containments-tab" data-bs-toggle="tab"
                                                ...
                                                aria-controls="action-containments" aria-selected="true">{{ __('incident.Containments') }}</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="action-eradications-tab" data-bs-toggle="tab"
                                                ...
                                                aria-controls="action-eradications" aria-selected="false">{{ __('incident.Eradications') }}</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="action-recoveries-tab" data-bs-toggle="tab"
                                                data-bs-target="#action-recoveries" type="button" role="tab"
                                                aria-controls="action-recoveries" aria-selected="false">{{ __('incident.Recoveries') }}</button>
                                        </li>
                                    </ul>
                                    <div class="tab-content" id="myActionTabContent">
                ...
                `;
                    ...
                    <div class="text-center py-4">
                        <div class="empty-state">
                            ...
                            <h5 class="text-muted">{{ __('incident.No logs found') }}</h5>
                            <p class="text-muted">{{ __('incident.There are no logs available for this action') }}.</p>
                        </div>
                    </div>
                `);
                }
