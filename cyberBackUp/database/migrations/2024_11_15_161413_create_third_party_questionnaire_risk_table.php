...
class CreateThirdPartyQuestionnaireRiskTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('third_party_questionnaire_risk', function (Blueprint $table) {
            $table->id();
            $table->foreignId('questionnaire_id')->constrained('third_party_questionnaires')->cascadeOnDelete()->cascadeOnUpdate();
    ...
    {
        Schema::dropIfExists('third_party_questionnaire_risk');
    }
}
