(function ($) {
  ...
  var optionscolumnchart = {
    ...
    colors: [CionAdminConfig.secondary, "#014d41", CionAdminConfig.primary],
    fill: {
      type: "gradient",
      gradient: {
        shade: "light",
      ...
      xaxis: [
        {
          ...
          strokeDashArray: 0,
          borderColor: CionAdminConfig.primary,
          label: {
            borderColor: CionAdminConfig.primary,
            offsetY: 20,
            style: {
              color: "#fff",
              background: CionAdminConfig.primary,
            },
            text: "Anno Test",
          },
        },
  ...
  var optionsuserchart = {
    ...
    colors: [
      CionAdminConfig.primary,
      CionAdminConfig.secondary,
      "#014d41",
      "#544fff",
    ],
    title: {
  ...
  var optionsCircle = {
    ...
    colors: [CionAdminConfig.secondary, CionAdminConfig.primary, "#014d41"],
    responsive: [{
      breakpoint: 767,
      options: {
        title: {
  ...
  var optionsProgress1 = {
    ...
    plotOptions: {
      bar: {
        ...
        barHeight: "15%",
        colors: {
          backgroundBarColors: [CionAdminConfig.primary],
    ...
    fill: {
      ...
      type: "gradient",
      gradient: {
        gradientToColors: [CionAdminConfig.primary],
      },
    },
    series: [
      {
  ...
  var optionsProgress2 = {
    ...
    plotOptions: {
      bar: {
        ...
        barHeight: "15%",
        colors: {
          backgroundBarColors: [CionAdminConfig.secondary],
          backgroundBarOpacity: 0.2,
    ...
    fill: {
      ...
      gradient: {
        inverseColors: false,
        gradientToColors: [CionAdminConfig.secondary],
      },
    },
    responsive: [{
      breakpoint: 767,
