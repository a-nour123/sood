...
class PhishingEmail extends Mailable
{
    ...
    public function build()
    {
        ...
        $body = str_replace('{PhishWebsitePage}',config('app.url') . '/public/PWPI/' . $this->emailData->website->id . '/click?PMTI=' . $this->emailData['id'] . '&PEI=' . $this->employee->id. '&PCI=' . $this->campaign_id, $body);
