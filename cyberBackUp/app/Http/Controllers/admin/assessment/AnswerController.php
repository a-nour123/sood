...
class AnswerController extends Controller
{
    public function index(Question $question)
    {
        ...
        if ($question->risk_assessment) {
            ...
            $data['assets'] = Asset::whereNotNull('asset_owner')->select('id', 'name')->orderBy('id')->get();
            $data['tags'] = Tag::all();
    ...
    public function store(AnswerRequest $request, Question $question)
    {
        ...
        unset($basic_data['answer_en'], $basic_data['answer_ar']);
    ...
    public function edit(Question $question, AssessmentAnswer $answer)
    {
        ...
        $rawAnswer = $answer->getRawOriginal('answer');
        // Optionally, decode it for frontend use
        $answer['answer_edit'] = json_decode($rawAnswer, true);
