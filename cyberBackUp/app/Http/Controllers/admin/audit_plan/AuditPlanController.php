...
class AuditPlanController extends Controller
{
    ...
    public function storeAduitResponsible(Request $request)
    {
        try {
            ...
            $audit->audit_function =  $validated['audit_function'];
    ...
    public function updateAduitResponsible(Request $request)
    {
        try {
            ...
            $audit->update([
                ...
                'audit_function'=> $validated['audit_function'],
        ...
        if ($request->ajax()) {
            ...
            $query = DB::table('audits_responsibles')
                ...
                ->select([
                    ...
                    'audits_responsibles.audit_type',
                    'audits_responsibles.audit_function',
            ...
            return DataTables::of($data)
                ...
                ->editColumn('audit_type', function ($row) {
                    return $row->audit_type == 1 
                        ? __('locale.Internal') 
                        : __('locale.External');
                })
            ->editColumn('audit_function', function ($row) {
                    return $row->audit_function == 1 
                        ? __('locale.New') 
                        : __('locale.Archieved');
                })
