...
class CommentAuditerListener
{
     ...
     * @return void
     */
    public function handle(CommentAuditer $event)
    {
        // Getting the action ID of the event
        $action1 = Action::where('name', 'replyComment')->first();
        ...
        $comment->Auditer = $comment->replier->name;
