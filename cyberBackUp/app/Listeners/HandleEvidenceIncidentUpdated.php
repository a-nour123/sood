...
class HandleEvidenceIncidentUpdated
{
     ...
     * Handle the event.
     *
     * @param  \App\Events\EvidenceIncidentUpdated  $event
     * @return void
     */
    public function handle(EvidenceIncidentUpdated $event)
    {

        // Get the action ID for Risk_Add
        $action1 = Action::where('name', 'evidence_incident_updated')->first();
