...
class IncidentDeletedListener
{
     ...
     * Handle the event.
     *
     * @param  \App\Events\IncidentDeleted  $event
     * @return void
     */
    public function handle(IncidentDeleted $event)
    {

        // Get the action ID for Risk_Add
        $action1 = Action::where('name', 'incident_deleted')->first();
