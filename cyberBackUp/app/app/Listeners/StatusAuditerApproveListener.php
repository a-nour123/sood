...
class StatusAuditerApproveListener
{
     ...
     * @return void
     */
    public function handle(StatusAuditerApprove $event)
    {
         // Getting the action ID of the event
         $action1 = Action::where('name', 'ApproveFromAuditer')->first();
         ...
         $status->Status = $status->auditer_status ?? 'No Action';
