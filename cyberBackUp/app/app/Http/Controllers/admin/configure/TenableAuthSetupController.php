        ...
        try {
            ...
            if ($tenableAuth && empty($request->secret_key) && empty($request->access_key)) {
                $request->merge([
                    ...
                    'access_key_category' => $tenableAuth->access_key_category,
                    'secret_key_category' => $tenableAuth->secret_key_category,
                ]);
            }
            ...
            $tenableAuth = TenableAuth::updateOrCreate(
                ...
                [
                    ...
                    'access_key_category' => $request->access_key_category,
                    'secret_key_category' => $request->secret_key_category,
