...
if ($("#flot-basic-chart").length > 0) {
    for (var a = [], b = 0; b < 14; b += .5) a.push([b, Math.sin(b)]);
        var c = {
            color: CionAdminConfig.secondary,
            data: [
            [0, 3],
            [4, 8],
            [8, 5],
        ...
        function plotAccordingToChoices() {
            ...
            if (data.length > 0) {
                $.plot("#toggling-series-flot", data, {
                    ...
                    colors: [CionAdminConfig.primary, "#f8d62b" ,"#a927f9" ,"#51bb25" , CionAdminConfig.secondary , "#dc3545" ,"#f8d62b"]
...
$(function() {
    ...
    var data4_errors = [0.1, 0.4, 0.2];
        ...
        var data = [
            {color: "#FF6150", points: data1_points, data: data1, label: "data1"},
            ...
            {color: "#44225c", bars: {show: true, align: "center", barWidth: 0.25}, data: data4, label: "data4"},
...
$(function() {
    ...
    $.plot('#default-pie-flot-chart', data, {
        ...
        colors: [ CionAdminConfig.primary , "#51bb25" ,"#f8d62b" ,"#a927f9" ,"#dc3545", "#6c757d" , CionAdminConfig.secondary ]
    });
