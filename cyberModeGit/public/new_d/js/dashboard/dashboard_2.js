(function ($) {
  "use strict";
    ...
    colors: ['#e9e9ef' , '#e9e9ef' ,'#e9e9ef' , '#e9e9ef','#44225c' , '#e9e9ef', '#e9e9ef' , '#e9e9ef','#e9e9ef' , '#e9e9ef','#e9e9ef' , '#e9e9ef','#e9e9ef' , '#e9e9ef','#e9e9ef' , '#e9e9ef' , '#e9e9ef','#e9e9ef' , '#e9e9ef','#e9e9ef' , '#e9e9ef', , '#e9e9ef','#e9e9ef' , '#e9e9ef' ],
    fill: {
      type: 'gradient',
      gradient: {
        shade: 'light',
