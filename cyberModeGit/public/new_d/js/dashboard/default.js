...
var options = {
  ...
  colors: ["#44225c21", "#44225c21", "#44225c21", "#44225c21", "#44225c21", "#44225c21", "#44225c21", "#44225c"],
  chart: {
    height: 95,
    type: 'bar',
    offsetY: 30,
...
totalLikesEl.render();
var totalLikesEl = new ApexCharts(document.querySelector('#totalLikesAreaChart1'), totalLikesOption);
totalLikesEl.render();
...
var IncomechrtchartEl2 = new ApexCharts(document.querySelector("#Incomechrt2"), income2);
IncomechrtchartEl2.render();
...
var options = {
    ...
    colors: ["#35bfbf21", "#35bfbf21", "#35bfbf21", "#35bfbf21", "#35bfbf21", "#35bfbf21", "#35bfbf21", "#44225c"],
    chart: {
      height: 95,
      type: 'bar',
      offsetY: 30,
