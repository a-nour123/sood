...
function drawBasic() {
  ...
  if ($("#pie-chart1").length > 0) {
      ...
      var options = {
        ...
        width:'100%',
        height: 300,
       colors: ["#f8d62b", "#51bb25" , "#a927f9"  , CionAdminConfig.secondary , CionAdminConfig.primary ]
      };
  ...
  if ($("#pie-chart4").length > 0) {
      ...
      var options = {
        ...
        slices: {  4: {offset: 0.2},
          ...
          colors: ["#dc3545", CionAdminConfig.primary , CionAdminConfig.secondary , "#51bb25", "#a927f9", "#f8d62b","#dc3545", CionAdminConfig.primary , "#f8d62b", "#51bb25", CionAdminConfig.primary , CionAdminConfig.secondary ,"#51bb25", CionAdminConfig.primary , "#a927f9", "#f8d62b", CionAdminConfig.primary , CionAdminConfig.primary, "#a927f9", CionAdminConfig.secondary , CionAdminConfig.primary , "#51bb25"]
        };
  ...
  if ($("#combo-chart").length > 0) {
      ...
      var options = {
        ...
        height: 500,
        width:'100%',
        colors: [CionAdminConfig.primary, CionAdminConfig.secondary , "#51bb25", "#a927f9", "#f8d62b"]
    };
  ...
  if ($("#area-chart2").length > 0) {
    ...
    var options = {
      ...
      width:'100%',
      height: 400,
      colors: [CionAdminConfig.primary , CionAdminConfig.secondary , "#51bb25", "#f8d62b"]
    };
    ...
    var options = {
        ...
        gantt: {
            ...
            arrow: {
                ...
                palette: [
                    {
                        "color": CionAdminConfig.primary,
                        "dark": CionAdminConfig.secondary ,
                        "light": "#047afb"
                    }
                ]
