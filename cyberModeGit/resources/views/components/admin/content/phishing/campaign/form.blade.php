...
aria-labelledby="myExtraLargeModal" aria-hidden="true" id="{{ $id }}" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title form-title" id="myExtraLargeModal">{{ $title }}</h4>
                ...
                <div class="col-xl-12">
                    <div class="card height-equal">
                        <div class="card-header pb-0">
                            {{--  <h3 class="my-3">{{ __('phishing.NewCampaignWizard') }}</h3>  --}}
                        </div>
                        ...
                        <div class="card-body basic-wizard important-validation">
                            <div class="stepper-horizontal" id="stepper1">
                                <div class="stepper-one stepper step editing active">
                                    ...
                                    <div class="step-title">{{ __('phishing.Employee_Selection') }}</div>
                                    <div class="step-bar-left"></div>
                                    <div class="step-bar-right"></div>
                                </div>
                                <div class="stepper-two step">
                                    <div class="step-circle"><span>2</span></div>
                                    <div class="step-title">{{ __('phishing.Select_Material') }}</div>
                                    <div class="step-bar-left"></div>
                                    <div class="step-bar-right"></div>
                                </div>
                                ...
                                <div class="stepper-five step">
                                    <div class="step-circle"><span>2</span></div>
                                    <div class="step-title">{{ __('phishing.Select_Training_Module') }}</div>
                                    <div class="step-bar-left"></div>
                                    <div class="step-bar-right"></div>
                                </div>
                                ...
                                <div class="stepper-three step">
                                    ...
                                    <div class="step-title">{{ __('phishing.Delivery_Schedule') }}</div>
                                    <div class="step-bar-left"></div>
                                    <div class="step-bar-right"></div>
                                </div>
                                <div class="stepper-four step">
                                    <div class="step-circle"><span>4</span></div>
                                    <div class="step-title">{{ __('phishing.Review_Submit') }}</div>
                                    <div class="step-bar-left"></div>
                                    <div class="step-bar-right"></div>
                                </div>
                            </div>
                            ...
                            <div id="msform">
                                <hr>
                                {{-- Step 1 show in all cases --}}
                                <form class="stepper-one khaled row g-3 needs-validation custom-input" novalidate="" id="form-step-one">
                                    <div class="col-sm-5">
                                        <input type="hidden" class="form-campaign-id" name="campaign_id">
                                        <label class="form-label" for="campaign-name-basic-wizard" title="This can be anything you want. We recommend something that will help to uniquely identify this campaign from others (e.g. &quot;All-Staff-Mar-23&quot;).">{{ __('phishing.campaign_name') }}: <span class="txt-danger">*</span></label>
                                        <input class="form-control" id="campaign-name-basic-wizard" name="campaign_name" type="text" required="required" placeholder="{{ __('phishing.Enter_a_unique_campaign_name') }}">
                                        <span class="error error-campaign_name text-danger my-2"></span>
                                    </div>

                                    <div class="col-sm-4">
                                        <label class="form-label" for="campaign-type-basic-wizard" title="What type of campaign are you looking to schedule? Simulated Phishing? Security Awareness Training? Or combine both together, and only assign training to those who fall victim to phishing">{{ __('phishing.campaign_type') }}: <span class="txt-danger">*</span></label>
                                        <select class="form-select select2" aria-label="Default select example" id="type_of_campaign" name="campaign_type" required="required" id="">
                                            <option value="simulated_phishing">{{ __('phishing.Simulated_Phishing') }}</option>
                                            <option value="security_awareness">{{ __('phishing.Security_Awareness') }}</option>
                                    ...
                                    <div class="col-sm-12 row">
                                        <div class="col-sm-12 my-3">
                                            <b>{{ __('phishing.Select_Employees') }}</b>
                                        </div>

                                    <div class="col-sm-5">
                                        {{--  <h6 class="my-3">{{ __('phishing.Available_Employee_Lists') }}</h6>
                                    ...
                                    <div class="col-sm-2">
                                            <div class="col d-flex flex-column justify-content-center" style="margin-top: 0; margin-left: 50px;">
                                    ...
                                    <div class="col-sm-5">
                                            {{--  <h6 class="my-3">{{ __('phishing.Selected_Employee_List') }}</h6>
                                            ...
                                            <span class="error error-checkedEmployees text-danger my-2"></span>
                                            {{-- <span class="error error-selected_employees text-danger my-2"></span> --}}
                                            <button type="button" class="btn btn-sm btn-warning my-2" id="filter-employees">{{ __('phishing.Filter_employees') }}</button>
                                    </div>
                                    </div>
                                ...
                                {{-- Step 2 if campaign_type security_awareness || simulated_phishing_and_security_awareness --}}
                                <form class="stepper-five khaled row g-3 needs-validation custom-input" novalidate="" id="form-step-five">
                                    <div class="col-md-12" style="max-height: 400px; overflow: scroll">
                                        <div class="row">
                                            {{-- <div class="col-6">
                                                <label class="form-label text-bold" for="campaign-name-basic-wizard" >{{ __('phishing.Training_Language') }}<span class="txt-danger">*</span></label>
                                                <input class="form-control" id="module_language" name="module_language" type="text">
                                                <span class="error error-module_language text-danger my-2"></span>
                                            </div> --}}
                                            ...
                                            <div class="col-4">
                                                <label class="form-label text-bold" for="campaign-name-basic-wizard" >{{ __('phishing.Courses') }}</label>
                                                <select class="form-select select2 selected_course" aria-label="Default select example" name="selected_course" required="required">
                                                    <option value="">{{ __('phishing.Select_Course') }}</option>
                                            ...
                                            <div class="col-4">
                                                <label class="form-label text-bold" for="campaign-name-basic-wizard" >{{ __('phishing.Levels') }}</label>
                                                <select class="form-select select2 selected_course_levels" aria-label="Default select example" name="selected_course_levels" required="required">
                                                    <option value="">{{ __('phishing.select_Levels') }}</option>
                                                    {{-- @foreach ($levels as $level)
                                                        <option value="{{$level->id}}">{{$level->title}}</option>
                                                    @endforeach --}}
                                                </select>
                                                <span class="error error-selected_course_levels text-danger my-2"></span>
                                            </div>

                                            <div class="col-4">
                                                <label class="form-label text-bold" for="campaign-name-basic-wizard" >{{ __('phishing.Days_Until_Due') }} <span class="txt-danger">*</span></label>
                                                <input class="form-control" id="days_until_due" name="days_until_due" type="number">
                                                <span class="error error-days_until_due text-danger my-2"></span>
                                            </div>

                                            {{-- <div class="col-md-12 my-4">
                                                <label class="form-label text-bold" for="campaign-name-basic-wizard" >{{ __('phishing.Training_Module_Selection') }}</label>
                                                <input class="form-control" id="search" name="search" type="text" placeholder="Type the name of Training Module.... in Progress">
                                                <span class="error error-training_modules text-danger my-2"></span>
                                            </div> --}}

                                            <div id="course_level_training_module" class="row col-md-12">
                                                @foreach ($trainingModules as $training_module)
                                                    <div class="col-md-4 my-5">
                                                        <div class="card email-template-card">
                                                            <div class="card-header pb-0 my-4">
                                                                @if ($training_module->level)
                                                                    <span class="topleftcorner">skil level : {{ $training_module->level->title ?? '' }}</span>
                                                                @endif
                                                                <span class="topcorner">Est.: {{$training_module['completion_time']}} Minuits</span>
                                                                <span class="text-center">{{ $training_module->title }}</span>
                                                            </div>

                                                            <div class="training-card-body">
                                                                <div class="overlay">
                                                                    <img src="{{ asset('storage/'.$training_module['cover_image']) }}" alt="Overlay" class="training-overlay-image">
                                                                </div>
                                                            </div>
                                                        </div>

                                                        <div class="btn-container">
                                                            <input type="checkbox" id="checkbox-training-module-{{ $training_module['id'] }}" class="btn-check" name="training_modules[]" value="{{ $training_module['id'] }}">
                                                            <label class="btn btn-outline-primary w-100" for="checkbox-training-module-{{ $training_module['id'] }}">
                                ...
                                {{-- Step 2 if campaign_type simulated_phishing || simulated_phishing_and_security_awareness --}}
                                <form class="stepper-two khaled row g-3 needs-validation custom-input" novalidate="" id="form-step-two">
                                    <div class="col-md-12" style="max-height: 400px; overflow: scroll">
                                        <div class="row">
                                            {{--  <div class="col-12">
                                                ...
                                                <div class="col-md-4 mb-4">
                                                    <div class="card email-template-card" onclick="openEmailTemplate({{ $template['id'] }})">
                                                        <div class="card-header pb-0 my-4">
                                                            ...
                                                            <span class="topcorner">{{ __('phishing.Payload') }}: {{$template['payload_type']}}</span>
                                                        </div>
                                                    ...
                                                    <div class="btn-container">
                                                        ...
                                                        <label class="btn btn-outline-primary w-100" for="checkbox-{{ $template['id'] }}">
                                                            {{ __('phishing.Select_this_attack') }}
                                                        </label>
                                                    </div>
                                                </div>
                                            @endforeach
                                ...
                                {{-- Step 3 if campaign_type simulated_phishing || simulated_phishing_and_security_awareness --}}
                                <form class="stepper-three khaled row g-3 needs-validation custom-input" novalidate="" id="form-step-three">

                                    <!-- First Tabs: Phishing Delivery Schedule -->
                                    <div class="col-sm-12">
                                        <div class="my-3">
                                            <b class="form-label" for="email-basic"> {{ __('phishing.Phishing_Delivery_Schedule') }} <span class="txt-danger">*</span></b>
                                        </div>
                                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <div class="nav-link">
                                                    <input type="radio" id="deliver-immediately" name="delivery_type" value="immediatly" checked>
                                                    <label for="deliver-immediately">{{ __('phishing.Deliver_Immediately') }}</label>
                                                </div>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <div class="nav-link">
                                                    <input type="radio" id="setup-schedule" name="delivery_type" value="setup">
                                                    <label for="setup-schedule">{{ __('phishing.Setup_Schedule') }}</label>
                                                </div>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <div class="nav-link">
                                                    <input type="radio" id="schedule-later" name="delivery_type" value="later">
                                                    <label for="schedule-later">{{ __('phishing.Schedule_Later') }}</label>
                                                </div>
                                            </li>
                                        </ul>
                                        <div style="display: none" id="block-of-setup">
                                            <div class="col-12">
                                                <p><b>{{ __('phishing.note') }}:</b> {{ __('phishing.deleivery_schedual_note') }}</p>
                                            </div>
                                            <div class="row">
                                                <div class="col-6">
                                                    <label class="form-label" for="schedule-date-from" title="This can be anything you want. We recommend something that will help to uniquely identify this campaign from others (e.g. 'All-Staff-Mar-23')."> {{ __('phishing.Schedule_date_from') }}: <span class="txt-danger">*</span></label>
                                                ...
                                                <div class="col-6">
                                                    <label class="form-label" for="schedule-date-to" title="This can be anything you want. We recommend something that will help to uniquely identify this campaign from others (e.g. 'All-Staff-Mar-23')."> {{ __('phishing.Schedule_date_to') }}:<span class="txt-danger">*</span></label>
                                                ...
                                                <div class="col-6">
                                                    <label class="form-label" for="schedule-time-from" title="This can be anything you want. We recommend something that will help to uniquely identify this campaign from others (e.g. 'All-Staff-Mar-23')."> {{ __('phishing.Schedule_time_from') }}: <span class="txt-danger">*</span></label>
                                                ...
                                                <div class="col-6">
                                                    <label class="form-label" for="schedule-time-to" title="This can be anything you want. We recommend something that will help to uniquely identify this campaign from others (e.g. 'All-Staff-Mar-23')."> {{ __('phishing.Schedule_time_to') }}:<span class="txt-danger">*</span></label>
                                ...
                                {{-- Step 4 show in all cases --}}
                                <form class="stepper-four khaled row g-3 needs-validation custom-input mt-2" id="form-step-four">
                                    <!-- Campaign Name -->
                                    <div class="form-group row">
                                        <label for="campaignName" class="col-sm-2 col-form-label">{{ __('phishing.campaign_name') }}</label>
                                        <div class="col-sm-10">
                                    ...
                                    <!-- Campaign Type -->
                                    <div class="form-group row">
                                        <label for="campaignType" class="col-sm-2 col-form-label">{{ __('phishing.campaign_type') }}</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="campaignType" name="campaignType" value="" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <!-- Phishing Bundle -->
                                    <div id="simulated-phishing-case" style="display: none;">
                                    ...
                                    <!-- Schedule Between Days -->
                                    <div class="schedual-data" style="display: none">
                                        <div class="form-group row">
                                            <label for="scheduleDays" class="col-sm-2 col-form-label">Schedule (Between Days)</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="scheduleDays" value="" disabled>
                                    ...
                                    <div id="training-module-section" style="display: none">
                            ...
                            <div class="wizard-footer d-flex gap-2 justify-content-end mt-3">
                                <button class="btn alert-light-primary" disabled id="backbtn" onclick="backStep()"> {{ __('phishing.back') }}</button>
                                <button class="btn btn-primary" id="nextbtn" onclick="validateStep()">{{ __('phishing.next') }}</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<style>
    ...
    .training-card-body .overlay {
        display: block !important; /* تأكد أن العنصر دائمًا ظاهر */
        opacity: 1 !important; /* يجعل الصورة مرئية */
