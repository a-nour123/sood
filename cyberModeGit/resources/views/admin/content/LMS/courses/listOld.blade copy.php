                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                            <div class="coursebox">
                                                    ...
                                                    <div class="coursebox-img">
                                                        ...
                                                        <div class="author-block author-wrap">
                                                            ...
                                                            <span
                                                                ...
                                                                {{ \Carbon\Carbon::parse($new_courselist_value['updated_date'])->format('Y-m-d') }}</span>
                                                        </div>
                                                    </div>
                                                    <div class="coursebox-body">
                                                        <h4>{{ $new_courselist_value['title'] }}:</h4>
                                                        <div class="course-caption">
                                                            {{ $new_courselist_value['description'] }}</div>
                                                        <div class="classstats">
                                                            <div><i class="fa fa-list-alt"></i>{{ __('lms.Levels') }}
                                                                -
                                                                {{ $new_courselist_value['levels_count'] }}</div>
                                                ...
                                                <div class="coursebtn ">
                                                    ...
                                                    {{-- <a href="#" class="btn course_preview_id pull-right btn-custom w-100 text-white" style="background: #44225c !important ;" data-id="{{ $new_courselist_value['id'] }}" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#course_preview_modal">{{ __('course_preview') }}</a> --}}
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
...
<div class="modal fade" id="add_training_module_modal" style="z-index: 9999999" aria-labelledby="wizardModalLabel"
    aria-hidden="true">
                                ...
                                <div class="col-sm-12 row main-statement-content">
                                    ...
                                    <div class="row col-sm-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" required class="form-control statement_title"
                                    ...
                                    <div class="row col-sm-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" required class="form-control statement_title_ar"
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" required class="form-control statement_content_ar"
...
<div class="modal fade" id="edit_training_module_modal" style="z-index: 9999999" aria-labelledby="wizardModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form id="edit-training-module" method="POST" enctype="multipart/form-data">
                    ...
                    <div>
                        <div class="text-end pt-3">
                            {{-- <button class="btn btn-primary" id="edit_training_btn" type="submit">Update</button> --}}
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <form id="add_lesson_form" method="post" enctype="multipart/form-data" class="ptt10">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="add_lesson_thumbnail">{{ __('inline_preview_image') }} (700px
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="lesson_selectedID">{{ __('lesson_type') }}</label><small
                                                class="req"> *</small>
                                            <select class="form-control" id="lesson_selectedID"
                                                name="lessons_type" onchange="geteditcontent(this.value)">
                                                <option value="">{{ __('select') }}</option>
                                                @foreach ($lesson_type ?? [] as $key => $lvalue)
                                                    <option value="{{ $key }}">{{ $lvalue }}
                                                    </option>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <form id="edit_question_form" method="post">
                                ...
                                <div id="edit_question"></div> <!-- Dynamic question content will be injected here -->
                            </form>
                        </div>
                    </div>
                </div>
...
<script>
                ...
                <div class="col-sm-12 row main-statement-content">
                    ...
                    <div class="row col-sm-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" required class="form-control question" name="items[${index}][question]"  placeholder="Enter a question title English">
                    ...
                    <div class="row col-sm-6">
                         <div class="form-group mb-3">
                            ...
                            <input type="text" required class="form-control question" name="items[${index}][question_ar]"  placeholder="Enter a question title Arabic">
                    ...
                    <div class="row col-sm-6">
                        <div class="multi-chose-div">
                            <div class="form-group mb-1 row col-md-12">
                                <div class="input-group pl-1">
                                    ...
                                    <input id="tMQOption21" type="text" required name="items[${index}][options][]" class="form-control" aria-label="Enter an answer option" placeholder="Enter an answer English option" maxlength="350">
                                    <div class="input-group-append">
                                        <div data-toggle="tooltip" data-placement="top" title="Is this the correct answer?" class="input-group-text">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" required id="option21" name="items[${index}][correct_answer]" class="custom-control-input correct_answer">
                            ...
                            <div class="form-group mb-1 row col-md-12">
                                <div class="input-group pl-1">
                                    ...
                                    <input id="tMQOption22" type="text" required  name="items[${index}][options][]" class="form-control" aria-label="Enter an answer option" placeholder="Enter an answer English option" maxlength="350">
                                    <div class="input-group-append">
                                        <div data-toggle="tooltip" data-placement="top" title="Is this the correct answer?" class="input-group-text">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" required id="option22" name="items[${index}][correct_answer]" class="custom-control-input correct_answer">
                            ...
                            <div class="form-group mb-1 row col-md-12">
                                <div class="input-group pl-1">
                                    ...
                                    <div class="input-group-append">
                                        <div data-toggle="tooltip" data-placement="top" title="Is this the correct answer?" class="input-group-text">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" required id="option23" name="items[${index}][correct_answer]" class="custom-control-input correct_answer">
                            ...
                            <div class="form-group mb-2 row col-md-12">
                                <div class="input-group pl-1">
                                    ...
                                    <div class="input-group-append">
                                        <div data-toggle="tooltip" data-placement="top" title="Is this the correct answer?" class="input-group-text">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" required id="option24" name="items[${index}][correct_answer]" class="custom-control-input correct_answer">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea type="text" class="form-control answer_description description" required rows="2" name="items[${index}][answer_description]" placeholder="Enter an answer English description"></textarea>
                    ...
                    <div class="row col-sm-6">
                        <div class="multi-chose-div">
                            <div class="form-group mb-1 row col-md-12">
                                <div class="input-group pl-1">
                                    ...
                                    <input id="tMQOption21" type="text" required name="items[${index}][options_ar][]" class="form-control" aria-label="Enter an answer option" placeholder="Enter an answer option Arabic" maxlength="350">
                                    <div class="input-group-append">
                                        <div data-toggle="tooltip" data-placement="top" title="Is this the correct answer?" class="input-group-text">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" disabled id="option21" name="items[${index}][correct_answer_ar]" class="custom-control-input correct_answer">
                            ...
                            <div class="form-group mb-1 row col-md-12">
                                <div class="input-group pl-1">
                                    ...
                                    <input id="tMQOption22" type="text" required  name="items[${index}][options_ar][]" class="form-control" aria-label="Enter an answer option" placeholder="Enter an answer option" maxlength="350">
                                    <div class="input-group-append">
                                        <div data-toggle="tooltip" data-placement="top" title="Is this the correct answer?" class="input-group-text">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" disabled id="option22" name="items[${index}][correct_answer_ar]" class="custom-control-input correct_answer">
                            ...
                            <div class="form-group mb-1 row col-md-12">
                                <div class="input-group pl-1">
                                    ...
                                    <div class="input-group-append">
                                        <div data-toggle="tooltip" data-placement="top" title="Is this the correct answer?" class="input-group-text">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" disabled id="option23" name="items[${index}][correct_answer_ar]" class="custom-control-input correct_answer">
                            ...
                            <div class="form-group mb-2 row col-md-12">
                                <div class="input-group pl-1">
                                    ...
                                    <div class="input-group-append">
                                        <div data-toggle="tooltip" data-placement="top" title="Is this the correct answer?" class="input-group-text">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" disabled id="option24" name="items[${index}][correct_answer_ar]" class="custom-control-input correct_answer">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea type="text" class="form-control answer_description_ar description" required rows="2" name="items[${index}][answer_description_ar]" placeholder="Enter an answer description"></textarea>
    ...
    function reclculateCounts() {
        $('#total_questions').text($('#main-statement-or-question-operation select.question_type').length);  // question_type select not input
    ...
    $(document).on('click', '.after_append_question', function() {
        ...
        let index = $('#main-statement-or-question-operation .col-sm-12').length;
            ...
            success: function(data) {
                if (data && data.status) {
                    ...
                    $.each(data.training_module, function(index, item) {
                        var pageIndex = item.content.page_number - 1; // Assuming page_number starts from 1
                        var itemType = item.type; // question or statement
                        var htmlContent = '';
                        let storageUrl = "{{asset('storage/')}}";

                        if (itemType === 'question') {
                            let optionsHtml = '' , optionsHtml_ar = '';
                                                ...
                                                <div class="input-group-append">
                                                    <div data-toggle="tooltip" data-placement="top" title="Is this the correct answer?" class="input-group-text">
                                                        <div class="custom-control custom-radio">
                                                            ...
                                                            <label class="custom-control-label" for="option_${index}_${optionIndex}">{{ __('lms.Answer') }}</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div data-toggle="tooltip" data-placement="top" title="Is this the correct answer?" class="input-group-text">
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio"
                                                                disabled
                                                                id="option_${index}_${optionIndex}"
                                                                name="items[${index}][correct_answer_ar]"
                                                                value="${option.option_text_ar}"
                                                                class="custom-control-input correct_answer"
                                                                ${option.is_correct ? 'checked' : ''}>
                                                            <label class="custom-control-label" for="option_${index}_${optionIndex}">{{ __('lms.Answer Arabic') }}</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            htmlContent = `
                                ...
                                <div class="col-sm-12 row edit-main-statement-content">
                                    <input type="hidden" class="question_id" name="items[${index}][question_id]" value="${item.content.id}">
                                    <input type="hidden" class="page_number" name="items[${index}][page_number]" value="${item.content.page_number}">
                                    <input type="hidden" class="item_type" name="items[${index}][type]" value="question">
                                    ...
                                    <div class="row col-sm-6">
                                        <div class="form-group mb-3">
                                            <label for="question">{{ __('lms.Question English') }}:</label>
                                            <input type="text" required class="form-control question" name="items[${index}][question]" value="${item.content.question}"  placeholder="Enter a question title English">
                                            <span class="emptyCommingError trainError-items-${index}-question text-danger"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row col-sm-6">
                                        <div class="form-group mb-3">
                                            <label for="question_ar">{{ __('lms.Question Arabic') }}:</label>
                                            <input type="text" required class="form-control question" name="items[${index}][question_ar]" value="${item.content.question_ar}"  placeholder="Enter a question title Arabic">
                                            <span class="emptyCommingError trainError-items-${index}-question_ar text-danger"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row col-sm-6">
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="answer_description">{{ __('lms.Answer Description English') }}:</label>
                                            <textarea type="text" class="form-control answer_description description" required rows="2" name="items[${index}][answer_description]" placeholder="Enter an answer English description">${item.content.answer_description || ''}</textarea>
                                            <span class="emptyCommingError trainError-items-${index}-answer_description text-danger"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row col-sm-6">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea type="text" class="form-control answer_description_ar description" required rows="2" name="items[${index}][answer_description_ar]" placeholder="Enter an answer English description">${item.content.answer_description_ar || ''}</textarea>
                                            <span class="emptyCommingError trainError-items-${index}-answer_description_ar text-danger"></span>
                                        </div>
                                    </div>
                            ...
                            htmlContent = `
                                ...
                                <div class="col-sm-12 row edit-main-statement-content">
                                    <input type="hidden" class="statement_id" name="items[${index}][statement_id]" value="${item.content.id}">
                                    <input type="hidden" class="page_number" name="items[${index}][page_number]" value="${item.content.page_number}">
                                    <input type="hidden" class="item_type" name="items[${index}][type]" value="statement">
                                    ...
                                    <div class="row col-sm-6">
                                        <div class="col-sm-12 form-group mb-3 video-embedded-en"
                                            ...
                                            <span class="emptyCommingError trainError-items-${index}-video_url_en text-danger"></span>
                                        </div>
                                        ...
                                        <div class="col-sm-12 row form-group mb-3 image-embedded"
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <input type="file" accept="image/*" class="form-control image"
                                                    name="items[${index}][image]"
                                                    placeholder="{{ __('lms.Choose Statement Image English') }}">
                                                <span class="emptyCommingError trainError-items-${index}-image text-danger"></span>
                                    ...
                                    <div class="row col-sm-6">
                                        <div class="col-sm-12 form-group mb-3 video-embedded" style="display: ${item.content.additional_content === 'video' ? 'block' : 'none'};">
                                            ...
                                            <span class="emptyCommingError trainError-items-${index}-video_url text-danger"></span>
                                        </div>
                                        ...
                                        <div class="col-sm-12 row form-group mb-3 image-embedded"
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <input type="file" accept="image/*" class="form-control image"
                                                    name="items[${index}][image_ar]"
                                                    placeholder="{{ __('lms.Choose Statement Image Arabic') }}">
                                                <span class="emptyCommingError trainError-items-${index}-image_ar text-danger"></span>
    ...
    function reclculateEditCounts() {
        $('#edit_total_questions').text($('#edit-main-statement-or-question-operation select.edit_question_type').length);
        $('#edit_total_statements').text($('#edit-main-statement-or-question-operation select.edit_additional_content').length);
    ...
    $(document).on('click', '.edit_after_append_question', function() {
        ...
        let index = $('#edit-main-statement-or-question-operation .col-sm-12').length;
