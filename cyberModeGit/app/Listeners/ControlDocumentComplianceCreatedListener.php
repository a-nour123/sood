...
class ControlDocumentComplianceCreatedListener
{
     ...
     * @return void
     */
    public function handle(ControlDocumentComplianceCreated $event)
    {
        // Get the action ID for Risk_Add
        $action1 = Action::where('name', 'control_docuemt_add_update')->first();
