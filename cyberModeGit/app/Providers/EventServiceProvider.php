...
use App\Listeners\AssetCommentCreatedListener;
use App\Listeners\CommentAuditeeListener;
use App\Listeners\CommentAuditerListener;
use App\Listeners\ControlDocumentComplianceActionStatusListener;
use App\Listeners\ControlDocumentComplianceCreatedListener;
use App\Listeners\ControlDocumentComplianceDeletedListener;
...
use App\Listeners\DocumentCommentCreatedListener;
...
use App\Listeners\HandleEvidenceIncidentCreated;
use App\Listeners\HandleEvidenceIncidentDeleted;
use App\Listeners\HandleEvidenceIncidentUpdated;
use App\Listeners\HandlePlayBookCategoryIncidentAction;
use App\Listeners\IncidentCommentCreatedListener;
use App\Listeners\IncidentCreatedListener;
use App\Listeners\IncidentDeletedListener;
use App\Listeners\IncidentIraCreatedListener;
use App\Listeners\PolicyAdoptionCreatedListener;
use App\Listeners\PolicyAdoptionDeletedListener;
use App\Listeners\PolicyAdoptionStatusChangedListener;
use App\Listeners\PolicyAdoptionUpdatedListener;
...
use App\Listeners\TaskCommentCreatedListener;
...
class EventServiceProvider extends ServiceProvider
{
    ...
    protected $listen = [
        ...
        AssetCommentCreated::class => [
            AssetCommentCreatedListener::class,
        ],
        TaskCommentCreated::class => [
            TaskCommentCreatedListener::class,
        ],
        DocumentCommentCreated::class => [
            DocumentCommentCreatedListener::class,
        ],
        PolicyAdoptionCreated::class => [
            PolicyAdoptionCreatedListener::class,
        ],
        PolicyAdoptionUpdated::class => [
            PolicyAdoptionUpdatedListener::class,
        ],
        PolicyAdoptionDeleted::class => [
            PolicyAdoptionDeletedListener::class,
        ],
        PolicyAdoptionStatusChanged::class => [
            PolicyAdoptionStatusChangedListener::class,
        ],
        ControlDocumentComplianceCreated::class => [
            ControlDocumentComplianceCreatedListener::class,
        ],
        ControlDocumentComplianceDeleted::class => [
            ControlDocumentComplianceDeletedListener::class,
        ],
        ControlDocumentComplianceDeleted::class => [
            ControlDocumentComplianceDeletedListener::class,
        ],
        ControlDocumentComplianceActionStatus::class => [
            ControlDocumentComplianceActionStatusListener::class,
        ],
        IncidentCommentCreated::class => [
            IncidentCommentCreatedListener::class,
        ],
        EvidenceIncidentCreated::class => [
            HandleEvidenceIncidentCreated::class,
        ],
        EvidenceIncidentUpdated::class => [
            HandleEvidenceIncidentUpdated::class,
        ],
        EvidenceIncidentDeleted::class => [
            HandleEvidenceIncidentDeleted::class,
        ],
        playBookCategoryIncidentAction::class => [
            HandlePlayBookCategoryIncidentAction::class,
        ],
        IncidentDeleted::class => [
            IncidentDeletedListener::class,
        ],
