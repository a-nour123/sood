...
class RiskCreatedListener
{
     ...
     * Handle the event.
     *
     * @param  \App\Events\RiskCreated  $event
     * @return void
     */
    public function handle(RiskCreated $event)
    {
        // Get the action ID for Risk_Add
        $action1 = Action::where('name', 'Risk_Add')->first();
        ...
        $risk->Additional_Stakeholder = $additionalStakeholdersNames ?? null;
