...
class FrameworkUpdatedListener
{
     ...
     * Handle the event.
     *
     * @param  \App\Events\FrameworkUpdated  $event
     * @return void
     */
    public function handle(FrameworkUpdated $event)
    {
          // Get the action ID for Risk_Add
          $action1 = Action::where('name','Framework_Update')->first();
