                ...
                <div class="status-cards">
                    ...
                    <div class="status-card">
                        ...
                        <div class="card-content">
                            <h3 class="card-title fs-6 mb-1" style="color: #898989 !important;">
                                {{ __('locale.TotalDocuments') }}
                            </h3>
                    ...
                    <div class="status-card">
                        ...
                        <div class="card-content">
                            <h3 class="card-title fs-6 mb-1">{{ __('locale.DraftDocuments') }}</h3>
                    ...
                    <div class="status-card">
                        ...
                        <div class="card-content">
                            <h3 class="card-title fs-6 mb-1">{{ __('locale.InReviewDocuments') }}</h3>
                            <div class="card-number fw-bolder">
                    ...
                    <div class="status-card">
                        ...
                        <div class="card-content">
                            <h3 class="card-title fs-6 mb-1">{{ __('locale.ApprovedDocuments') }}</h3>
                            <div class="card-number fw-bolder">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-3">
            <div class="d-flex align-items-center gap-3 flex-wrap">
                <div class="mb-0 h3 d-flex align-items-center gap-2">
                    <p class="fs-4 mb-0">{{ __('locale.Templates') }} : </p>
            ...
            @if (auth()->user()->hasPermission('category.create'))
                <button id="add-new-template" class="btn btn-primary" type="button" data-bs-toggle="modal"
                    ...
                    <i class="fas fa-plus me-2"></i> {{ __('locale.New Category') }}
                </button>
            @endif
        </div>
                ...
                <div class="action-content" style="display: inherit !important; align-items: center !important;">
                    ...
                    @if (auth()->user()->hasPermission('document.create'))
                        ...
                        <button id="add-new-template" class="btn btn-primary" type="button" data-bs-toggle="modal"
                            ...
                            <i class="fas fa-plus me-2"></i> {{ __('locale.NewDocument') }}
                        </button>
            ...
            <div class="card">
                ...
                <div class="modal fade" id="documentLog" tabindex="-1" aria-labelledby="documentLogModalLabel"
                    ...
                    <div class="modal-dialog modal-xl modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="documentLogModalLabel">{{ __('locale.DocumentLogs') }}</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
